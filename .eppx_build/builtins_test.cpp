...
int main() {
    ...
    eppx_print(std::string("all([1, 2, 3]):"), eppx_all(std::vector<long long>{}));
    eppx_print(std::string("any([0, 0, 1]):"), eppx_any(std::vector<long long>{}));
    eppx_print(std::string("reversed([1, 2, 3]):"), eppx_reversed(std::vector<long long>{}));
